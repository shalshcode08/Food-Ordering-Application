  ...
  return (
    <>
        <h1 className="text-2xl font-bold tracking-tighter flex flex-col gap-5 md:flex-row md:justify-between">
            <span>Order Status : <span className="font-semibold">{getOrderStatusInfo().label}</span></span>
            <span>Expected by : <span className="font-semibold">{getExpectedDelivery()}</span></span>
        </h1>
